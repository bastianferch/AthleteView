...
class ActivityDTO(
    ...
    fun toEntity(): Activity {
        return Activity(id,null, accuracy, averageBpm, minBpm, maxBpm, distance, spentKcal, cadence, avgPower, maxPower, fitData, startTime, endTime, plannedActivity?.toEntity(), laps.map { it.toEntity() } , activityType)
    }
